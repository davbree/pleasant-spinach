...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://dev-api.stackbit.com/pull/6051bbd76991da001665f48b
...
To start editing your site, you can use the Sanity interface at https://pleasant-spinach-1bbd7.sanity.studio/.
...
Generated at `2021-03-17T08:20:56.304Z` by Stackbit version `0.3.50`.